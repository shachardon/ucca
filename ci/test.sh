...
unit)
    ...
    ;;
sparse)
    python parsing/parse.py -c sparse -WeLMCbs pickle/dev -t pickle/dev -I2
    ;;
dense)
    python parsing/parse.py -c dense -w word_vectors/sskip.100.vectors.txt -WeLMCbs pickle/dev -t pickle/dev -I2
    ;;
mlp)
