...
def main(args):
    ...
    prefix = args.server_address + API_PREFIX + "user_tasks/"
    for task_id in args.task_ids:
        task = requests.get(prefix + str(task_id), headers=headers).json()
...
if __name__ == "__main__":
    ...
    argparser.add_argument("task-ids", nargs="+", type=int, help="IDs of tasks to download and convert")
    ...
    argparser.add_argument("--server-address", default=DEFAULT_SERVER, help="UCCA-App server")
